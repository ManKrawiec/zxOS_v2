...
# c++
	...
	$(GPP) $(CPP_SOURCE)/zx/UI/renderer.cpp -o $(BUILD_CPP_SOURCE)/ui_renderer.o
	$(GPP) $(CPP_SOURCE)/zx/UI/terminal.cpp -o $(BUILD_CPP_SOURCE)/ui_terminal.o
	$(GPP) $(CPP_SOURCE)/zx/UI/theme.cpp -o $(BUILD_CPP_SOURCE)/ui_theme.o
	$(GPP) $(CPP_SOURCE)/zx/UI/effect.cpp -o $(BUILD_CPP_SOURCE)/ui_effect.o
	$(GPP) $(CPP_SOURCE)/zx/UI/effect_matrix.cpp -o $(BUILD_CPP_SOURCE)/ui_effect_matrix.o
	$(GPP) $(CPP_SOURCE)/zx/UI/input.cpp -o $(BUILD_CPP_SOURCE)/ui_input.o
	$(GPP) $(CPP_SOURCE)/zx/UI/kernel_tick.cpp -o $(BUILD_CPP_SOURCE)/ui_kernel_tick.o

	$(GPP) $(CPP_SOURCE)/zx/Assets/Fonts/BitFont.cpp -o $(BUILD_CPP_SOURCE)/assets_bitfont.o
...
# link
	$(LD) $(BUILD_ASM_SOURCE)/multiboot2.o $(BUILD_ASM_SOURCE)/setup.o \
		...
		$(BUILD_CPP_SOURCE)/ui_renderer.o $(BUILD_CPP_SOURCE)/ui_terminal.o \
		$(BUILD_CPP_SOURCE)/ui_theme.o $(BUILD_CPP_SOURCE)/ui_effect.o \
		$(BUILD_CPP_SOURCE)/ui_effect_matrix.o $(BUILD_CPP_SOURCE)/ui_input.o \
		$(BUILD_CPP_SOURCE)/ui_kernel_tick.o \
		$(BUILD_CPP_SOURCE)/assets_bitfont.o \
